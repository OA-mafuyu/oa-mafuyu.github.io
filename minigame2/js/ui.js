...
export const ui = {
  ...
  startBtn: $('startBtn'), retryBtn: $('retryBtn'), returnQuizBtn: $('returnQuizBtn'),
  musicBtn: $('musicBtn'),
  ...
  homeQuizBtn: $('homeQuizBtn'), exitConfirm: $('exitConfirm'),
  exitYesBtn: $('exitYesBtn'), exitNoBtn: $('exitNoBtn')
};
